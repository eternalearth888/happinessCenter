...
function wp_widget_pages( $args ) {
	...
	$out = wp_list_pages( array( 'title_li' => '',     'echo' => 0,
	                             'depth' => $depth,    'sort_column' => $sortby,
                               'exclude' => $exclude ) );
...
?>
		<p><label for="pages-title"><?php _e('Title:'); ?>
		  <input class="widefat" id="pages-title" name="pages-title" type="text" value="<?php echo $title; ?>" />
    </label></p>
		<p>
		...
		<p>
			<label for="pages-depth"><?php _e( 'Display depth:' ); ?>
			  <input type="text" value="<?php echo $depth; ?>" name="pages-depth" id="pages-depth" class="widefat" size="5"/>
      </label>
		</p>
		<p>
			<label for="pages-exclude"><?php _e( 'Exclude:' ); ?>
			  <input type="text" value="<?php echo $exclude; ?>" name="pages-exclude" id="pages-exclude" class="widefat" />
      </label>
			<br />
...
function wp_widget_search_control() {
	...
	$title = attribute_escape($options['title']);
?>
			<p><label for="search-title"><?php _e('Title:'); ?>
